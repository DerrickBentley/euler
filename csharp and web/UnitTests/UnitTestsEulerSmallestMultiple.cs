...
namespace UnitTests
{
    ...
    public class UnitTestsEulerSmallestMultiple
    {
        ...
        public void Test_Euler_problem_5_isDivisibleEvenly(int from, int upto, int number, bool expected)
        {
        ...
        public void Test_Euler_problem_5_findSmallestMultiple(int from, int upto, int expected)
        {
